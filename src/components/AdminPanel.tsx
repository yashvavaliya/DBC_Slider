        ...
        <header className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-40 transition-transform duration-300 translate-y-0">
          ...
          {mobileNavOpen && (
            <div className="fixed inset-0 z-50 flex justify-center items-start">
              <div
                className="bg-white rounded-2xl shadow-2xl w-80 mt-10 p-10 relative flex flex-col items-center"
                      ...
                      <div className="flex flex-col sm:flex-row items-center gap-1">
                        ...
                        <div className="flex-1 w-full sm:w-auto space-y-4">
                          ...
                          <div className="w-full">
                            ...
                            />
                            <p className="text-xs text-gray-500 mt-1">
                              This username will auto-sync across all your
                  ...
                  {activeTab === "design" && (
                    <div className="space-y-6 flex flex-col relative min-h-[60vh]">
                      ...
                      {showCongrats && (
                        ...
                        >
                          <span
                            className="text-6xl mb-3 animate-bounce-emoji"
                            style={{ display: "inline-block" }}
                          >
                            🎉
                          </span>
                          <span className="text-2xl font-extrabold text-gradient bg-gradient-to-r from-pink-500 via-blue-500 to-green-400 bg-clip-text text-transparent mb-2 animate-congrats-scale">
                            Congratulations!
                          </span>
                          <span className="text-lg text-gray-700 font-medium animate-congrats-fade">
                            You successfully built your card.
                          </span>
                          <style>{`
